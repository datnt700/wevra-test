...
export const Styled = {
  ...
  Goal: styled.p`
    ...
    border-radius: 8px;
    border-left: 4px solid ${(props) => (props.theme as TaviaTheme).colors.primary};
  `,
  ...
  Milestone: styled.div`
    ...
    background: linear-gradient(
      135deg,
      ${(props) => (props.theme as TaviaTheme).colors.successLight}20,
      ${(props) => (props.theme as TaviaTheme).colors.infoLight}20
    );
    border-radius: 12px;
    border: 2px dashed ${(props) => (props.theme as TaviaTheme).colors.border.default};
    display: flex;
    align-items: center;
    gap: 1rem;
  `,
  ...
  AIInsight: styled.div`
    ...
    background: ${(props) => (props.theme as TaviaTheme).colors.surface};
    border-radius: 8px;
    border-left: 4px solid ${(props) => (props.theme as TaviaTheme).colors.info};
  `,
  AIText: styled.p`
    font-size: 0.9375rem;
    color: ${(props) => (props.theme as TaviaTheme).colors.text.secondary};
