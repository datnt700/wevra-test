...
export const Styled = {
  AssistantContainer: styled.div<{ $isOpen: boolean }>`
    ...
    border-left: ${(props) =>
      props.$isOpen ? `1px solid ${(props.theme as TaviaTheme).colors.border.default}` : 'none'};
  ...
  ToggleButton: styled.button<{ $isOpen: boolean }>`
    ...
    color: ${(props) => (props.theme as TaviaTheme).colors.text.inverse};
    cursor: pointer;
    display: flex;
    align-items: center;
    ...
    &:hover {
      background: ${(props) => (props.theme as TaviaTheme).colors.primaryHover};
  ...
  CloseButton: styled.button`
    ...
    &:hover {
      background-color: ${(props) => (props.theme as TaviaTheme).colors.primaryHover};
    }
  ...
  QuickActionButton: styled.button`
    ...
    &:hover {
      ...
      background-color: ${(props) => (props.theme as TaviaTheme).colors.gray.mainColorLight}10;
    }
  `,
  ...
  MessageBubble: styled.div<{ $isUser?: boolean }>`
    ...
    color: ${(props) =>
      props.$isUser
        ? (props.theme as TaviaTheme).colors.text.inverse
        : (props.theme as TaviaTheme).colors.text.primary};
    font-size: 0.9375rem;
    line-height: 1.5;
