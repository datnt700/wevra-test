...
const StatIcon = styled.div<{ $color?: string }>`
  ...
  background-color: ${(props) =>
    props.$color || (props.theme as TaviaTheme).colors.gray.mainColorLight}20;
  color: ${(props) => props.$color || (props.theme as TaviaTheme).colors.primary};
  display: flex;
  align-items: center;
...
const TransactionAmount = styled.div<{ $type?: 'earned' | 'spent' }>`
  ...
  color: ${(props) =>
    props.$type === 'spent'
      ? (props.theme as TaviaTheme).colors.danger
