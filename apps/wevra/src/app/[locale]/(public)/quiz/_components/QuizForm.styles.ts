...
export const Styled = {
  ...
  ProgressBar: styled.div`
    height: 1rem;
    background-color: ${(props) => (props.theme as EventureTheme).colors.gray.gray200};
    border-radius: 999px;
    overflow: hidden;
    position: relative;
  `,
  ...
  ProgressFill: styled.div<{ $progress: number }>`
    ...
    background: linear-gradient(
      90deg,
      ${(props) => (props.theme as EventureTheme).colors.primary} 0%,
      ${(props) => (props.theme as EventureTheme).colors.gray.mainColorLight} 100%
    );
  ...
  BackButton: styled.button`
    ...
    border: 2px solid ${(props) => (props.theme as EventureTheme).colors.gray.gray300};
    ...
    &:hover {
      ...
      border-color: ${(props) => (props.theme as EventureTheme).colors.gray.gray400};
    }
  ...
  NextButton: styled.button<{ $isDisabled?: boolean }>`
    ...
    background: ${(props) =>
      props.$isDisabled
        ? (props.theme as EventureTheme).colors.gray.gray400
    ...
    &:hover {
      background: ${(props) =>
        props.$isDisabled
          ? (props.theme as EventureTheme).colors.gray.gray400
          : (props.theme as EventureTheme).colors.gray.mainColorLight};
