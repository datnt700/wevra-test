                    ...
                    data: {
                      ...
                      properties: {
                        ...
                        supportedEvents: {
                          type: 'array',
                          items: { type: 'string' },
                          example: ['user.created', 'user.updated', 'payment.success', 'payment.failed'],
                        },
                      },
                    },
                  },
    ...
    schemas: {
      User: {
        ...
        properties: {
          ...
          email: { type: 'string', format: 'email', example: 'user@example.com' },
          name: { type: 'string', example: 'John Doe' },
          role: { type: 'string', enum: ['ADMIN', 'ORGANIZER', 'MODERATOR', 'ATTENDEE'], example: 'ATTENDEE' },
      ...
      UserProfile: {
        ...
        properties: {
          ...
          avatar: { type: 'string', format: 'uri', example: 'https://example.com/avatar.jpg', nullable: true },
