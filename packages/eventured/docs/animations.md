# Animations in @eventure/eventured

The `@eventure/eventured` library provides two approaches for animations:
...
import {
  ...
  createAnimation,
  transition,
} from '@eventure/eventured/lib/animations';
```
...
import { animations } from '@eventure/eventured/lib/animations';
...
```typescript
import styled from '@emotion/styled';
import { transition } from '@eventure/eventured/lib/animations';
...
Framer Motion is already included as a dependency in `@eventure/eventured`.
