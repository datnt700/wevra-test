...
const StyledCheckboxRoot = styled(RadixCheckbox.Root, {
  ...
  ${({ theme, $isDisabled, $size = 'default' }) => {
    ...
    return `
      ...
      border: 1px solid ${eventureTheme.colors.text.primary};
      ...
      `
          : `
        &:hover {
          background-color: ${eventureTheme.colors.gray.mainColorLight6};
        ...
        &[data-state="checked"] {
          ...
          &:hover {
            background-color: ${eventureTheme.colors.gray.mainColorDark};
          }
        }
      `
      }
