...
const StyledRadioItem = styled(RadioGroup.Item)<{
  ...
  ${({ theme, $size = 'default', $isDisabled }) => {
    ...
    return `
      ...
      border-radius: 100%;
      border: 2px solid ${eventureTheme.colors.border.default};
      ...
      &:hover:not(:disabled) {
        ...
        background-color: ${eventureTheme.colors.primary}20;
      }
...
const StyledLabel = styled.label<{
  ...
  ${({ theme, $size = 'default', $isDisabled }) => {
    ...
    const styles = getSizeStyles($size);
    return `
      color: ${$isDisabled ? eventureTheme.colors.text.disabled : eventureTheme.colors.text.primary};
      ...
      &:hover {
        color: ${$isDisabled ? eventureTheme.colors.text.disabled : eventureTheme.colors.primary};
      }
    `;
  }}
`;
