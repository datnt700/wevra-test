  ...
  Wrapper: styled.div`
    ${({ theme }) => {
      ...
      return `
        ...
        .rdp {
          --rdp-accent-color: ${eventureTheme.colors.primary};
          --rdp-background-color: ${eventureTheme.colors.gray.mainColorLight9};
          margin: 0;
        }
        ...
        .rdp-day {
          ...
          &:hover:not(:disabled) {
            background-color: ${eventureTheme.colors.surfaceHover};
            border-color: ${eventureTheme.colors.gray.mainColorLight3};
          }
        ...
        /* Selected state */
        .rdp-day_selected {
          background-color: ${eventureTheme.colors.primary} !important;
          border-color: ${eventureTheme.colors.primary} !important;
          color: ${eventureTheme.colors.text.inverse} !important;
          font-weight: 600;
        ...
        .rdp-day_range_middle {
          background-color: ${eventureTheme.colors.gray.mainColorLight9} !important;
          color: ${eventureTheme.colors.text.primary} !important;
