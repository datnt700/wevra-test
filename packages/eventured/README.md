...
**Eventure Core UI Component Library** - A modern, type-safe React component
library built with Emotion, Radix UI, and TypeScript.

## Overview

`@eventure/eventured` is a comprehensive UI component library designed for the
Eventure booking platform. It follows a **flat directory structure** inspired by
...
```bash
# npm
npm install @eventure/eventured

# yarn
yarn add @eventure/eventured

# pnpm
pnpm add @eventure/eventured
```
...
```tsx
import { ThemeWrapper, theme } from '@eventure/eventured';
...
```tsx
import { Form, Field, Input, Button, Label } from '@eventure/eventured';
...
```tsx
import { Modal, Button } from '@eventure/eventured';
...
```tsx
import { theme, cssVars } from '@eventure/eventured';
...
```tsx
import { ThemeWrapper, darkThemeCssVars } from '@eventure/eventured';
...
```tsx
import { ButtonProps, ModalProps, InputProps } from '@eventure/eventured';
...
import { Modal } from '@eventure/eventured/components/dialogs/Modal';
```

**After:**

```tsx
import { Button, Modal } from '@eventure/eventured';
// or
import { Button } from '@eventure/eventured/ui/button';
import { Modal } from '@eventure/eventured/ui/modal';
```
...
- 📚 [Storybook Documentation](https://eventure-io.github.io/eventure)
- 🐛 [Issue Tracker](https://github.com/eventure-io/eventure/issues)
- 💬 [Discussions](https://github.com/eventure-io/eventure/discussions)
