# Animations in @tavia/core

The `@tavia/core` library provides two approaches for animations:
...
import {
  ...
  createAnimation,
  transition,
} from '@tavia/core/lib/animations';
```
...
import { animations } from '@tavia/core/lib/animations';
...
```typescript
import styled from '@emotion/styled';
import { animations, createAnimation } from '@tavia/core/lib/animations';
...
```typescript
import styled from '@emotion/styled';
import { transition } from '@tavia/core/lib/animations';
...
Framer Motion is already included as a dependency in `@tavia/core`.
