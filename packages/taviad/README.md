...
`@tavia/taviad` is a comprehensive UI component library designed for the Tavia
...
```bash
# npm
npm install @tavia/taviad

# yarn
yarn add @tavia/taviad

# pnpm
pnpm add @tavia/taviad
```
...
```tsx
import { ThemeWrapper, theme } from '@tavia/taviad';
...
```tsx
import { Form, Field, Input, Button, Label } from '@tavia/taviad';
...
```tsx
import { Modal, Button } from '@tavia/taviad';
...
```tsx
import { theme, cssVars } from '@tavia/taviad';
...
```tsx
import { ThemeWrapper, darkThemeCssVars } from '@tavia/taviad';
...
```tsx
import { ButtonProps, ModalProps, InputProps } from '@tavia/taviad';
...
import { Modal } from '@tavia/taviad/components/dialogs/Modal';
```

**After:**

```tsx
import { Button, Modal } from '@tavia/taviad';
// or
import { Button } from '@tavia/taviad/ui/button';
import { Modal } from '@tavia/taviad/ui/modal';
```
